...
import icon from '/assets/img/icon/project-details-icon.png'
import image2 from '/assets/img/portfolio/project-details-2.png'
import image1 from '/assets/img/portfolio/project-details.png'
...
function RouteComponent() {
  ...
  const singleData = portfolioData.find(
            ...
            <div className="project__details-content">
              <div className="project__details-content-bottom">
                <p>
                  ...
                  standard dummy text ever since the 1500s, when an unknown
                  printer took a galltype and scrambled it to make a type
                  specimen book. It has survived a only five centuries tinto
                  electronic typesetting remaining essentially unchanged Lorem
                  Ipsum is simply dummy text of the printing and typesetting
                  industry. Lorem Ipsum has been{' '}
                </p>
