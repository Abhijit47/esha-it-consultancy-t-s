              ...
              <div className="col-xl-4 col-lg-4 col-md-6">
                <div className="pricing-plan__one-single-pricing-wrapper">
                  <div className="pricing-plan__one-single-pricing-plan">
                    <h3 className="pricing-plan__one-single-pricing-plan-title">
                      Basic
                    </h3>
                    ...
                    <p>
                      Essential Security Suite Perfect for startups and small
                      teams
                    </p>
                    <div className="pricing-plan__one-single-pricing-plan-benefits">
                      <span>
                        <i className="fas fa-angle-double-right"></i>Mistakes To
                        Avoid
                      </span>
                      <span>
                        <i className="fas fa-angle-double-right"></i>Your
                        Startup
                      </span>
                      <span>
                        <i className="fas fa-angle-double-right"></i>Knew About
                        Fonts
                      </span>
                    </div>
                    <a href="/request-quote" className="btn-one">
              ...
              <div className="col-xl-4 col-lg-4 col-md-6">
                <div className="pricing-plan__one-single-pricing-wrapper">
                  <div className="pricing-plan__one-single-pricing-plan active">
                    ...
                    <p>
                      Data Analytics Tools Ideal for growing businesses
                      requiring
                    </p>
                    <div className="pricing-plan__one-single-pricing-plan-benefits">
                      <span>
                    ...
                    <a href="/request-quote" className="btn-two">
                      Get Started<i className="fas fa-chevron-right"></i>
                    </a>
                  </div>
                </div>
