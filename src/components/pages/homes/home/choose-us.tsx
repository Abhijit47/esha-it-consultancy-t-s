import image2 from '/assets/img/shape/why-choose-shape.png'
import image1 from '/assets/img/why-choose-us/why-choose.png'
            ...
            <div className="col-xl-6 col-lg-7 col-md-9">
              <div className="why-choose-us__one-left">
                <div className="why-choose-us__one-title">
                  ...
                  <p>
                    Craft personalized action plans harnessing the latest IT
                    innovations to support your business objectives driving
                    growth advantage
                  </p>
                </div>
                <div className="why-choose-us__one-quality">
                  <div className="why-choose-us__one-quality-single">
                    ...
                    <div className="why-choose-us__one-quality-single-content">
                      ...
                      <p>
                        Harness ingenuity and foresight, we consistently pioneer
                        advanced solutions that set industry
                      </p>
                    </div>
                  </div>
                  <div className="why-choose-us__one-quality-single">
                    ...
                    <div className="why-choose-us__one-quality-single-content">
                      ...
                      <p>
                        Day or night, our global support team stands ready,
                        providing reliable assistance and technical
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="why-choose-us__one-image">
                <div className="why-choose-us__one-image-shape">
                  ...
                  <img
                    src={image2}
                    alt="image"
                    className="shape shape-3 animate-y-axis"
                  />
                </div>
